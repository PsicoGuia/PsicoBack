...
urlpatterns = [
    ...
    path(r'chat/<int:pk>/', views.ChatDetailView.as_view(),
         name='chat-detail'),
    path(r'home-visit/', views.HomeVisitListView.as_view(),
         name="home-visit-list"),
    path(r'home-visit/<int:pk>/', views.HomeVisitDetailView.as_view(),
         name='home-visit-detail'),
    ...
    path(r'attention-channel/', views.AttentionChannelListView.as_view(),
         name="scheduleAttentionChannel-list"),
    path(r'attention-channel/<int:pk>/', views.AttentionChannelDetailView.as_view(),
         name='scheduleAttentionChannel-detail'),
    path(r'schedule-attention-channel/', views.RequestOrderMedicDateListView.as_view(),
         name="scheduleAttentionChannel-list"),
    path(r'schedule-attention-channel/<int:pk>/', views.ScheduleAttentionChannelDetailView.as_view(),
         name='scheduleAttentionChannel-detail'),
    path(r'image-attention-channel/', views.ImageAttentionChannelListView.as_view(),
         name="imageAttentionChannel-list"),
    path(r'image-attention-channel/<int:pk>/', views.ImageAttentionChannelDetailView.as_view(),
